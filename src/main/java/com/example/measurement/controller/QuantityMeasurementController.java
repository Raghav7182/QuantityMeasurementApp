...
import com.example.measurement.dto.QuantityInputDTO;
import com.example.measurement.dto.QuantityMeasurementDTO;
...
public class QuantityMeasurementController {
    ...
    private ResponseEntity<QuantityDTO> response(QuantityDTO result) {
        if (result.isError()) {
            throw new com.example.measurement.exception.Exception(result.getErrorMessage());
        }
